...
pub const TYPE_IDENTIFIER_WITH_TYPE: [u8; 4] = 34u32.to_ne_bytes();
pub const TYPE_IF_STATEMENT: [u8; 4] = 35u32.to_ne_bytes();
pub const TYPE_IMPORT_ATTRIBUTE: [u8; 4] = 36u32.to_ne_bytes();
pub const TYPE_IMPORT_DECLARATION: [u8; 4] = 37u32.to_ne_bytes();
pub const TYPE_IMPORT_DEFAULT_SPECIFIER: [u8; 4] = 38u32.to_ne_bytes();
pub const TYPE_IMPORT_EXPRESSION: [u8; 4] = 39u32.to_ne_bytes();
pub const TYPE_IMPORT_NAMESPACE_SPECIFIER: [u8; 4] = 40u32.to_ne_bytes();
pub const TYPE_IMPORT_SPECIFIER: [u8; 4] = 41u32.to_ne_bytes();
pub const TYPE_LABELED_STATEMENT: [u8; 4] = 42u32.to_ne_bytes();
pub const TYPE_LITERAL_BIG_INT: [u8; 4] = 43u32.to_ne_bytes();
pub const TYPE_LITERAL_BOOLEAN: [u8; 4] = 44u32.to_ne_bytes();
pub const TYPE_LITERAL_NULL: [u8; 4] = 45u32.to_ne_bytes();
pub const TYPE_LITERAL_NUMBER: [u8; 4] = 46u32.to_ne_bytes();
pub const TYPE_LITERAL_REG_EXP: [u8; 4] = 47u32.to_ne_bytes();
pub const TYPE_LITERAL_STRING: [u8; 4] = 48u32.to_ne_bytes();
...
pub const TYPE_OBJECT_EXPRESSION: [u8; 4] = 54u32.to_ne_bytes();
pub const TYPE_OBJECT_PATTERN: [u8; 4] = 55u32.to_ne_bytes();
pub const TYPE_PRIVATE_IDENTIFIER: [u8; 4] = 56u32.to_ne_bytes();
...
pub const TYPE_RETURN_STATEMENT: [u8; 4] = 61u32.to_ne_bytes();
pub const TYPE_SEQUENCE_EXPRESSION: [u8; 4] = 62u32.to_ne_bytes();
pub const TYPE_SPREAD_ELEMENT: [u8; 4] = 63u32.to_ne_bytes();
pub const TYPE_STATIC_BLOCK: [u8; 4] = 64u32.to_ne_bytes();
pub const TYPE_SUPER_ELEMENT: [u8; 4] = 65u32.to_ne_bytes();
pub const TYPE_SWITCH_CASE: [u8; 4] = 66u32.to_ne_bytes();
pub const TYPE_SWITCH_STATEMENT: [u8; 4] = 67u32.to_ne_bytes();
pub const TYPE_TAGGED_TEMPLATE_EXPRESSION: [u8; 4] = 68u32.to_ne_bytes();
pub const TYPE_TEMPLATE_ELEMENT: [u8; 4] = 69u32.to_ne_bytes();
pub const TYPE_TEMPLATE_LITERAL: [u8; 4] = 70u32.to_ne_bytes();
pub const TYPE_THIS_EXPRESSION: [u8; 4] = 71u32.to_ne_bytes();
pub const TYPE_THROW_STATEMENT: [u8; 4] = 72u32.to_ne_bytes();
pub const TYPE_TRY_STATEMENT: [u8; 4] = 73u32.to_ne_bytes();
pub const TYPE_TS_BOOLEAN_KEYWORD: [u8; 4] = 74u32.to_ne_bytes();
pub const TYPE_TS_INTERFACE_BODY: [u8; 4] = 75u32.to_ne_bytes();
pub const TYPE_TS_INTERFACE_DECLARATION: [u8; 4] = 76u32.to_ne_bytes();
pub const TYPE_TS_INTERFACE_HERITAGE: [u8; 4] = 77u32.to_ne_bytes();
pub const TYPE_TS_NULL_KEYWORD: [u8; 4] = 78u32.to_ne_bytes();
pub const TYPE_TS_NUMBER_KEYWORD: [u8; 4] = 79u32.to_ne_bytes();
pub const TYPE_TS_PROPERTY_SIGNATURE: [u8; 4] = 80u32.to_ne_bytes();
pub const TYPE_TS_STRING_KEYWORD: [u8; 4] = 81u32.to_ne_bytes();
pub const TYPE_TS_TYPE_ALIAS_DECLARATION: [u8; 4] = 82u32.to_ne_bytes();
pub const TYPE_TS_TYPE_ANNOTATION: [u8; 4] = 83u32.to_ne_bytes();
pub const TYPE_UNARY_EXPRESSION: [u8; 4] = 84u32.to_ne_bytes();
pub const TYPE_UPDATE_EXPRESSION: [u8; 4] = 85u32.to_ne_bytes();
pub const TYPE_VARIABLE_DECLARATION: [u8; 4] = 86u32.to_ne_bytes();
pub const TYPE_VARIABLE_DECLARATOR: [u8; 4] = 87u32.to_ne_bytes();
pub const TYPE_WHILE_STATEMENT: [u8; 4] = 88u32.to_ne_bytes();
pub const TYPE_YIELD_EXPRESSION: [u8; 4] = 89u32.to_ne_bytes();
...
pub const EXPORT_NAMED_DECLARATION_RESERVED_BYTES: usize = 24;
...
pub const EXPORT_NAMED_DECLARATION_EXPORT_KIND_OFFSET: usize = 20;
...
pub const IDENTIFIER_WITH_TYPE_RESERVED_BYTES: usize = 12;
pub const IDENTIFIER_WITH_TYPE_NAME_OFFSET: usize = 4;
pub const IDENTIFIER_WITH_TYPE_TYPE_ANNOTATION_OFFSET: usize = 8;
...
pub const TS_BOOLEAN_KEYWORD_RESERVED_BYTES: usize = 4;

pub const TS_INTERFACE_BODY_RESERVED_BYTES: usize = 8;
pub const TS_INTERFACE_BODY_BODY_OFFSET: usize = 4;

pub const TS_INTERFACE_DECLARATION_RESERVED_BYTES: usize = 20;
pub const TS_INTERFACE_DECLARATION_FLAGS_OFFSET: usize = 4;
pub const TS_INTERFACE_DECLARATION_DECLARE_FLAG: u32 = 1;
pub const TS_INTERFACE_DECLARATION_ID_OFFSET: usize = 8;
pub const TS_INTERFACE_DECLARATION_BODY_OFFSET: usize = 12;
pub const TS_INTERFACE_DECLARATION_EXTENDS_OFFSET: usize = 16;

pub const TS_INTERFACE_HERITAGE_RESERVED_BYTES: usize = 8;
pub const TS_INTERFACE_HERITAGE_EXPRESSION_OFFSET: usize = 4;

pub const TS_PROPERTY_SIGNATURE_RESERVED_BYTES: usize = 16;
pub const TS_PROPERTY_SIGNATURE_FLAGS_OFFSET: usize = 4;
pub const TS_PROPERTY_SIGNATURE_STATIC_FLAG: u32 = 1;
pub const TS_PROPERTY_SIGNATURE_COMPUTED_FLAG: u32 = 2;
pub const TS_PROPERTY_SIGNATURE_OPTIONAL_FLAG: u32 = 4;
pub const TS_PROPERTY_SIGNATURE_READONLY_FLAG: u32 = 8;
pub const TS_PROPERTY_SIGNATURE_KEY_OFFSET: usize = 8;
pub const TS_PROPERTY_SIGNATURE_TYPE_ANNOTATION_OFFSET: usize = 12;

pub const TS_TYPE_ALIAS_DECLARATION_RESERVED_BYTES: usize = 16;
pub const TS_TYPE_ALIAS_DECLARATION_FLAGS_OFFSET: usize = 4;
pub const TS_TYPE_ALIAS_DECLARATION_DECLARE_FLAG: u32 = 1;
pub const TS_TYPE_ALIAS_DECLARATION_ID_OFFSET: usize = 8;
pub const TS_TYPE_ALIAS_DECLARATION_TYPE_ANNOTATION_OFFSET: usize = 12;
...
pub const VARIABLE_DECLARATION_RESERVED_BYTES: usize = 16;
pub const VARIABLE_DECLARATION_FLAGS_OFFSET: usize = 4;
pub const VARIABLE_DECLARATION_DECLARE_FLAG: u32 = 1;
pub const VARIABLE_DECLARATION_KIND_OFFSET: usize = 8;
pub const VARIABLE_DECLARATION_DECLARATIONS_OFFSET: usize = 12;

pub const VARIABLE_DECLARATOR_RESERVED_BYTES: usize = 16;
pub const VARIABLE_DECLARATOR_FLAGS_OFFSET: usize = 4;
pub const VARIABLE_DECLARATOR_DEFINITE_FLAG: u32 = 1;
pub const VARIABLE_DECLARATOR_ID_OFFSET: usize = 8;
pub const VARIABLE_DECLARATOR_INIT_OFFSET: usize = 12;
