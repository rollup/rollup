...
pub const TS_INTERFACE_DECLARATION_RESERVED_BYTES: usize = 12;
pub const TS_INTERFACE_DECLARATION_ID_OFFSET: usize = 4;
pub const TS_INTERFACE_DECLARATION_BODY_OFFSET: usize = 8;
