...
pub const TYPE_JSX_CLOSING_ELEMENT: [u8; 4] = 43u32.to_ne_bytes();
pub const TYPE_JSX_CLOSING_FRAGMENT: [u8; 4] = 44u32.to_ne_bytes();
pub const TYPE_JSX_ELEMENT: [u8; 4] = 45u32.to_ne_bytes();
pub const TYPE_JSX_EMPTY_EXPRESSION: [u8; 4] = 46u32.to_ne_bytes();
pub const TYPE_JSX_EXPRESSION_CONTAINER: [u8; 4] = 47u32.to_ne_bytes();
pub const TYPE_JSX_FRAGMENT: [u8; 4] = 48u32.to_ne_bytes();
pub const TYPE_JSX_IDENTIFIER: [u8; 4] = 49u32.to_ne_bytes();
pub const TYPE_JSX_NAMESPACED_NAME: [u8; 4] = 50u32.to_ne_bytes();
pub const TYPE_JSX_OPENING_ELEMENT: [u8; 4] = 51u32.to_ne_bytes();
pub const TYPE_JSX_OPENING_FRAGMENT: [u8; 4] = 52u32.to_ne_bytes();
pub const TYPE_JSX_TEXT: [u8; 4] = 53u32.to_ne_bytes();
pub const TYPE_LOGICAL_EXPRESSION: [u8; 4] = 61u32.to_ne_bytes();
pub const TYPE_MEMBER_EXPRESSION: [u8; 4] = 62u32.to_ne_bytes();
pub const TYPE_META_PROPERTY: [u8; 4] = 63u32.to_ne_bytes();
pub const TYPE_METHOD_DEFINITION: [u8; 4] = 64u32.to_ne_bytes();
pub const TYPE_NEW_EXPRESSION: [u8; 4] = 65u32.to_ne_bytes();
pub const TYPE_PROGRAM: [u8; 4] = 69u32.to_ne_bytes();
pub const TYPE_PROPERTY: [u8; 4] = 70u32.to_ne_bytes();
pub const TYPE_PROPERTY_DEFINITION: [u8; 4] = 71u32.to_ne_bytes();
pub const TYPE_REST_ELEMENT: [u8; 4] = 72u32.to_ne_bytes();
pub const TYPE_SPREAD_ELEMENT: [u8; 4] = 75u32.to_ne_bytes();
pub const TYPE_TEMPLATE_LITERAL: [u8; 4] = 82u32.to_ne_bytes();
pub const TYPE_TRY_STATEMENT: [u8; 4] = 85u32.to_ne_bytes();
pub const TYPE_VARIABLE_DECLARATION: [u8; 4] = 88u32.to_ne_bytes();
pub const TYPE_VARIABLE_DECLARATOR: [u8; 4] = 89u32.to_ne_bytes();
...
pub const JSX_ATTRIBUTE_RESERVED_BYTES: usize = 12;
pub const JSX_ATTRIBUTE_NAME_OFFSET: usize = 4;
pub const JSX_ATTRIBUTE_VALUE_OFFSET: usize = 8;

pub const JSX_CLOSING_ELEMENT_RESERVED_BYTES: usize = 8;
pub const JSX_CLOSING_ELEMENT_NAME_OFFSET: usize = 4;
...
pub const JSX_ELEMENT_CHILDREN_OFFSET: usize = 8;
pub const JSX_ELEMENT_CLOSING_ELEMENT_OFFSET: usize = 12;
...
pub const JSX_FRAGMENT_CHILDREN_OFFSET: usize = 8;
pub const JSX_FRAGMENT_CLOSING_FRAGMENT_OFFSET: usize = 12;
