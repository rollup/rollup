...
pub const TYPE_TS_NUMBER_KEYWORD: [u8; 4] = 75u32.to_ne_bytes();
pub const TYPE_TS_PROPERTY_SIGNATURE: [u8; 4] = 76u32.to_ne_bytes();
pub const TYPE_TS_TYPE_ANNOTATION: [u8; 4] = 77u32.to_ne_bytes();
