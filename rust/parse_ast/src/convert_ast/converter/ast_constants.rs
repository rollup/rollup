...
pub const TYPE_JSX_ELEMENT: [u8; 4] = 42u32.to_ne_bytes();
pub const TYPE_JSX_IDENTIFIER: [u8; 4] = 43u32.to_ne_bytes();
pub const TYPE_JSX_OPENING_ELEMENT: [u8; 4] = 44u32.to_ne_bytes();
pub const TYPE_JSX_TEXT: [u8; 4] = 45u32.to_ne_bytes();
pub const TYPE_LOGICAL_EXPRESSION: [u8; 4] = 53u32.to_ne_bytes();
pub const TYPE_MEMBER_EXPRESSION: [u8; 4] = 54u32.to_ne_bytes();
pub const TYPE_META_PROPERTY: [u8; 4] = 55u32.to_ne_bytes();
pub const TYPE_METHOD_DEFINITION: [u8; 4] = 56u32.to_ne_bytes();
pub const TYPE_NEW_EXPRESSION: [u8; 4] = 57u32.to_ne_bytes();
pub const TYPE_PROGRAM: [u8; 4] = 61u32.to_ne_bytes();
pub const TYPE_PROPERTY: [u8; 4] = 62u32.to_ne_bytes();
pub const TYPE_PROPERTY_DEFINITION: [u8; 4] = 63u32.to_ne_bytes();
pub const TYPE_REST_ELEMENT: [u8; 4] = 64u32.to_ne_bytes();
pub const TYPE_SPREAD_ELEMENT: [u8; 4] = 67u32.to_ne_bytes();
pub const TYPE_TEMPLATE_LITERAL: [u8; 4] = 74u32.to_ne_bytes();
pub const TYPE_TRY_STATEMENT: [u8; 4] = 77u32.to_ne_bytes();
