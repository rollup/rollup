  ...
  fn convert_module_declaration(
    ...
    match module_declaration {
      ...
      ModuleDecl::ExportDefaultExpr(export_default_expression) => {
        self.convert_export_default_expression(export_default_expression, module_item_insert_position)
      }
      ...
      ModuleDecl::ExportDefaultDecl(export_default_declaration) => {
        self.convert_export_default_declaration(export_default_declaration, module_item_insert_position)
      }
