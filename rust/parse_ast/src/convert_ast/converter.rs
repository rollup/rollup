...
use swc_ecma_ast::{
  ...
  SimpleAssignTarget, Stmt, TsKeywordType, TsKeywordTypeKind, TsType, TsTypeElement, VarDeclOrExpr,
};
  ...
  pub fn convert_ts_type_element(&mut self, ts_type_element: &TsTypeElement) {
    match ts_type_element {
      TsTypeElement::TsCallSignatureDecl(_) => {
        todo!("TsTypeElement::TsCallSignatureDecl")
      }
      TsTypeElement::TsConstructSignatureDecl(_) => {
        todo!("TsTypeElement::TsConstructSignatureDecl")
      }
      TsTypeElement::TsPropertySignature(signature) => {
        self.convert_property_signature(signature);
      }
      TsTypeElement::TsGetterSignature(_) => {
        todo!("TsTypeElement::TsGetterSignature")
      }
      TsTypeElement::TsSetterSignature(_) => {
        todo!("TsTypeElement::TsSetterSignature")
      }
      TsTypeElement::TsMethodSignature(_) => {
        todo!("TsTypeElement::TsMethodSignature")
      }
      TsTypeElement::TsIndexSignature(_) => {
        todo!("TsTypeElement::TsIndexSignature")
      }
    }
  }
