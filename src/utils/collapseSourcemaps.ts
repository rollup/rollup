...
class Link {
	...
	traceSegment(line: number, column: number, name: string): SourceMapSegmentObject | null {
		...
		while (searchStart <= searchEnd) {
			...
			// the column is not precise (e.g. the sourcemap is generated by esbuild, segment[0] may be shorter than the location of the first letter), we
			// use the best approximation to get the closest segment whose segment[0] is shorter than the given column
