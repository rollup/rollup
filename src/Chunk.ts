...
type RenderedDependencies = Map<Chunk | ExternalChunk, ModuleDeclarationDependency>;
...
export default class Chunk {
	...
	private renderedDependencies: Map<Chunk | ExternalChunk, ModuleDeclarationDependency> | null =
		null;
