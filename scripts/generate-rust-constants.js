...
import { AST_NODES, astNodeNamesWithFieldOrder, astScopeNames } from './ast-types.js';
...
const scopeTypeMagicStartOffset = 42;
const scopeTypes = astScopeNames
	.map(
		(scopeType, index) =>
			`pub const ${toScreamingSnakeCase(scopeType)}: [u8; 4] = ${scopeTypeMagicStartOffset + index}u32.to_ne_bytes();`
	)
	.join('\n');
