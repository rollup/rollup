...
export declare function parseAndWalk(code: string, allowReturnOutsideFunction: boolean, jsx: boolean, walkedNodesBitset: BigUint64Array, collectScopes: boolean, signal?: AbortSignal | undefined | null): Promise<Buffer>
