...
import { rollup } from '../../dist/es/rollup.browser.js';
import { assertFilesAreEqual, runTestSuiteWithSamples, compareError } from '../utils.js';

runTestSuiteWithSamples(
	'form',
	resolve(dirname(fileURLToPath(import.meta.url)), 'samples'),
	(dir, config) => {
