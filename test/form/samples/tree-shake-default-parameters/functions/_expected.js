...
function funDecl(a = 'retained', b = 'retained', c, d = 'retained') {
	console.log(a, b, c);
}
...
const funExp = function (a = 'retained', b = 'retained', c, d = 'retained') {
	console.log(a, b, c);
};
...
const arrow = (a = 'retained', b = 'retained', c, d = 'retained') =>
	console.log(a, b, c);
