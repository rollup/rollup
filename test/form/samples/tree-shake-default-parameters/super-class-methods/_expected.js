...
class TestSuper {
	constructor(a = 'retained', b = 'retained', c, d = 'retained') {
		console.log(a, b, c);
	}

	static staticMethod(a = 'retained', b = 'retained', c, d = 'retained') {
		console.log(a, b, c);
	}

	static staticProp = (a = 'retained', b = 'retained', c, d = 'retained') =>
		console.log(a, b, c);
}
