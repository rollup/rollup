...
async function entry() {
	...
	// multiple
	const { bar2 } = await Promise.resolve().then(function () { return sub2; });
	bar2();
	...
	Promise.resolve().then(function () { return sub2; })
		.catch()
		.finally()
	...
	const { ...named2 } = await Promise.resolve().then(function () { return bail2$1; })(await Promise.resolve().then(function () { return bail3$1; }))[foo];
	...
	[Promise.resolve().then(function () { return bail7$1; }), Promise.resolve().then(function () { return bail8$1; })];
