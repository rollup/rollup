...
#### treeshake
Type: `boolean | { propertyReadSideEffects?: boolean, pureAnnotations?: boolean, pureExternalModules?: boolean }`<br>
...
**treeshake.pureAnnotations**<br>
Type: `boolean`<br>
CLI: `--treeshake.pureAnnotations`/`--no-treeshake.pureAnnotations`<br>
Default: `true`
